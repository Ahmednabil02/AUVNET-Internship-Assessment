...
import 'package:ecommerce/features/cart/presentation/views/order_screen.dart';
...
import '../../../cart/presentation/views/order_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _onItemTapped(int index) {
    if (index == 5) {
      // Assuming the Sign Out icon is at index 5
      _showSignOutDialog();
    } else {
      setState(() {
  ...
  Future<void> _signOut() async {
    ...
    try {
      await FirebaseAuth.instance
          .signOut(); // Adjust this line to your auth provider
